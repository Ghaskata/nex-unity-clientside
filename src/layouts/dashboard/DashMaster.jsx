  ...
  return (
    <div>
      <Sidebar toggleSidebar={toggleSidebar} settoggleSidebar={settoggleSidebar} />
      {
        toggleSidebar &&
        (
          <div className="w-full fixed z-50 top-0 start-0 bg-black/50 transition-all duration-500 ease-in">
            <Sidebar className="absolute start-0 z-50 transition-all duration-500 ease-in" />
          </div>
        )
      }
      <DashHeader toggleSidebar={toggleSidebar} settoggleSidebar={settoggleSidebar} />

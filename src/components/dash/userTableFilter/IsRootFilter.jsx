...
const IsRoot = ({ selectedIsRoot, setselectedIsRoot }) => {
    return (
        <Select onValueChange={(e) => setselectedIsRoot(e)} value={selectedIsRoot}>
            <SelectTrigger className=" h-12 w-full !border border-backgroundv3 focus:border focus:border-backgroundv3   text-textPrimary font-popins text-12 lg:text-14 bg-backgroundv2 rounded-lg py-3 px-3  ">

...
const MyCommunityCard = ({ data }) => {
  return (
    <div className="w-full relative hover:scale-[0.98] group/card rounded-xl border-2 border-backgroundv3 cursor-pointer shadow h-[250px] bg-backgroundv1 hover:bg-backgroundv2 overflow-hidden transition-all duration-300 ease-linear">
      <div className="h-[80px]  w-full bg-blueMain/60 group-hover/card:bg-blueMain  transition-all duration-300 ease-linear"></div>
      <button className="absolute top-3 end-3 text-white">
        <CgEditFlipH className="h-6 w-6" />
      </button>

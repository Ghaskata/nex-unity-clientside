    ...
    <div className="w-full pt-5 xxl:pt-10 px-3 xl:px-5 text-textPrimary ">
      <ul className="w-full flex justify-start gap-x-3 overflow-x-auto post-scroll">
        {category.map((item, index) => (
          <li className="cursor-pointer border border-textPrimary rounded-lg py-3 px-5 h-full w-full flex justify-center items-center text-center group/item"  key={index}>

...
import { AUTH_API_URL, CATEGORY_API_URL } from "../../security/axios";
...
const DashboardHome = () => {
  ...
  const usersqueryKey = useMemo(() => ["users"], []);
          ...
          >
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <span className="text-14 lg:text-16 xl:text-18 xxl:text-20 text-textGray">
                  {formatUserFriendlyCount(users.length)}
                </span>
              </div>
            </div>
            <div className="absolute -end-3 -bottom-4 w-[110%] h-full">
          ...
          >
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <span className="text-14 lg:text-16 xl:text-18 xxl:text-20 text-textGray">
                  {formatUserFriendlyCount(categories.length)}
                </span>
              </div>
            </div>
